...
import { Eye, EyeOff, Lock, User, Building, ArrowRight, Mail } from 'lucide-react-native';
          ...
          <View className="flex-1 justify-center py-8">
            ...
            <View className="space-y-4">
              ...
              <View>
                ...
                {errors.ownerName && (
                  <Text className="text-red-500 text-sm mt-1">{errors.ownerName}</Text>
                )}
              </View>
              ...
              <View>
                ...
                {errors.ownerEmail && (
                  <Text className="text-red-500 text-sm mt-1">{errors.ownerEmail}</Text>
                )}
              </View>
              ...
              <View>
                ...
                {errors.whatsappNumber && (
                  <Text className="text-red-500 text-sm mt-1">{errors.whatsappNumber}</Text>
                )}
              </View>
              ...
              {/* Business Type */}
              <View>
                <Text className="text-gray-700 font-medium mb-2">Business Type</Text>
                <ScrollView
                  horizontal
              ...
              {/* Years in Business */}
              <View>
                <Text className="text-gray-700 font-medium mb-2">Years in Business</Text>
                <ScrollView
                  horizontal
                  showsHorizontalScrollIndicator={false}
                  className="flex-row space-x-2"

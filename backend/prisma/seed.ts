...
async function main() {
  ...
  console.log(
    "Creating Demo Businesses (demo1@bizsawa.com & demo2@bizsawa.com)...",
  );
  ...
  for (const demoBiz of [demo1, demo2]) {
    ...
    await prisma.businessAchievement.createMany({
      data: [
        ...
        {
          title: "100 Customers",
          description: "Reached 100 total customers.",
          earned: true,
          businessId: demoBiz.id,
        },
        {
  ...
  console.log(
    `   Demo Businesses Generated: 2 (demo1@bizsawa.com, demo2@bizsawa.com)`,
  );

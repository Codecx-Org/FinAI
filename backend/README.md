...
- **Integrations:** 
  ...
  - **Pollinations AI:** AI-driven content generation for product images.
...
### 3. Products & AI Content
Manage inventory, pricing, and AI-generated imagery.

| Method | Endpoint | Description |
| :--- | :--- | :--- |
| `POST` | `/api/products` | Add a new product |
| `GET` | `/api/products?businessId=1` | List business products |
| `POST` | `/api/products/:id/generate-image` | Generate/Update AI image for product |
